...
- After data cleaning, we know 97 of the participants developed MCI.
...
- The resulting dataset `mci_merged` includes 94 observations, with 11
  variables
- The
  mci_merged`dataset has variables including`id`,`current_age`,`sex`,`educations`,`apoe4`(whether a person is an apoe4 carrier or non-carrier),`age_at_onset`,`baseline`,`time_2`,`time_4`,`time_6`,`time_8\`
