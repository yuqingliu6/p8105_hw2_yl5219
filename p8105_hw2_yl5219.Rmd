...
* After data cleaning, we know `r nrow(mci_baseline)` of the participants developed MCI.
* The average baseline age is `r round(mean(mci_baseline$current_age, na.rm = TRUE),2)` years old. 
